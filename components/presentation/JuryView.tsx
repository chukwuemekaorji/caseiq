      ...
      <div className="w-full max-w-5xl">
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          <div className="border-t-2 border-amber/70 bg-film/5 p-6">
            <p className="mb-3 font-mono text-[11px] uppercase tracking-[0.2em] text-amber">The other side will argue</p>
            <p className="text-lg leading-relaxed text-film/85">{claim.text}</p>
          </div>
          <div className="border-t-2 p-6" style={{ borderColor: accent, background: "rgba(45, 212, 167, 0.06)" }}>
            <p className="mb-3 font-mono text-[11px] uppercase tracking-[0.2em]" style={{ color: accent }}>
              Our response
            </p>
            <p className="text-lg leading-relaxed text-film/85">{response.text}</p>
          </div>
        </div>
      </div>
    );
